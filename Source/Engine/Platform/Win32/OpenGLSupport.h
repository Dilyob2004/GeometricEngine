...
#define ENUM_GL_ENTRYPOINTS(EnumMacro) \
	EnumMacro(PFNGLCREATEFRAMEBUFFERSPROC, glCreateFramebuffers) \
	EnumMacro(PFNGLTEXTURESTORAGE2DPROC, glTextureStorage2D) \
	EnumMacro(PFNGLTEXTURESUBIMAGE2DPROC, glTextureSubImage2D) \
	EnumMacro(PFNGLDRAWELEMENTSBASEVERTEXPROC, glDrawElementsBaseVertex) \
	EnumMacro(PFNGLCREATETEXTURESPROC, glCreateTextures) \
	EnumMacro(PFNGLCREATEBUFFERSPROC, glCreateBuffers) \
	EnumMacro(PFNGLCREATEVERTEXARRAYSPROC, glCreateVertexArrays) \
	EnumMacro(PFNGLBINDTEXTUREUNITPROC, glBindTextureUnit) \
