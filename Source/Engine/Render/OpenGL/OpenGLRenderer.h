...
namespace MeteorEngine
{
    ...
    public:
		...
		virtual void DrawQuad(const Vector3f& position, const Vector3f& rotation, const Vector3f& scale, const Vector4f& color, bool connectCamera) override;

        virtual void DrawTextureQuad(const std::shared_ptr<Texture2D> &, const Vector3f &, const Vector2f& )override;

        virtual void SetCamera(Camera2D)override;
		virtual void SetCamera(Camera)override;
