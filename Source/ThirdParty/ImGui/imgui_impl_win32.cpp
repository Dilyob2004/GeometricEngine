...
struct ImGui_ImplWin32_ViewportData
{
    ...
    ImGui_ImplWin32_ViewportData() { hDC = NULL; hGLRC = NULL;  Hwnd = NULL; HwndOwned = false;  DwStyle = DwExStyle = 0; }
...
static void ImGui_ImplWin32_CreateWindow(ImGuiViewport * viewport)
{
    ...
    int iPixelFormat = ChoosePixelFormat(vd->hDC, &pfd);
    SetPixelFormat(vd->hDC, iPixelFormat, &pfd);
    vd->hGLRC = wglCreateContext(vd->hDC);
    wglShareLists(g_HGLRC, vd->hGLRC);
}
