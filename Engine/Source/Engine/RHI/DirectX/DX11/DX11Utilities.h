...
namespace GeometricEngine
{
	...
	static D3D11_USAGE EngineTextureUsageToDX11(RHITextureUsage Usage)
	{
		switch (Usage)
		{
		case GeometricEngine::RHITextureUsage::Immutable: return D3D11_USAGE_IMMUTABLE;
		case GeometricEngine::RHITextureUsage::Default: return D3D11_USAGE_DEFAULT;
		case GeometricEngine::RHITextureUsage::Dynamic: return D3D11_USAGE_DYNAMIC;
		case GeometricEngine::RHITextureUsage::Staging: return D3D11_USAGE_STAGING;
		}
